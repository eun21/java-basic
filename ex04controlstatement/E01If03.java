...
public class E01If03 {
	...
	public static void main(String[] args) {
		...
		double avg = (kor+eng+math) / 3.0 ; // 실수의 결과를 얻기 위해 3.0으로 나눈다.
		...
		//if 사용 시, 구간별 조건 설정 시 큰 값을 먼저 쓰도록(지정)!
		/*
		if~else 구문을 구성할 때는 조건의 구간을 어떻게 설정하느냐에 따라 전혀 다른 결과가 나올 수 있으므로
		주의해야 한다.
