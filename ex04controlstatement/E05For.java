...
for문 : while문과 같은 반복문으로 초기값, 조건식, 증감식이 한 줄에 있어 반복의 횟수를
	...
	실행순서]
		초기값 -> 조건식 확인 -> 참일 때 실행 -> 증감식 -> 조건식 확인 -> 반복실행
		-> 조건이 거짓일 때 for문 탈출
 */
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		for문으로 무한루프를 만들 때 사용. 일반적으로는 while을 사용함
		 */
		int a = 1;
//		for(;;) {
...
//		}
		...
		/*
		 for문의 끝에 ;를 사용하면 반복할 문장이 없는 것으로 간주하여
		...
		/*
		for문의 초기값을 외부(넓은지역)에서 선언하면 해당 변수는 for문 안쪽(좁은지역)에서 사용할 수
		있다. 즉, 아래에 선언한 변수 i는 main 메소드의 지역변수가 된다.
		 */
		int i = 0;
		for (; i<=5 ; i++) {
		...
		/*
		연습문제] 구구단을 출력하는 프로그램을 for문으로 작성하시오. rererererererrer
		 */
