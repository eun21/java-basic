...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		float와 long의 연산결과를 long으로 바꾸고 싶다면
		방법 1 : float를 long으로 형변환 후 연산하거나,
		방법 2 : 계산결과 전체를 long형으로 명시적(강제)형변환 한다.
		 */
		...
		/*
		-실수형에서 기본형은 double이다.
		-소숫점이 있는 데이터를 컴파일러는 무조건 double로 인식힌다.
		-단, 소숫점이 없는 데이터는 float에 대입할 수 있다.
		-소숫점이 있는 데이터를 float에 대입하려면 접미사 f or F를 붙여줘야한다.
		-형변환도 가능하지만 Java에서는 권장하지 않는다.
		 */
		float f3=100;
		
		//float f4=3.14; => error발행] 3.14 자체를 double형으로 인식함.
		float f4=(float)3.14; //형변환 후 대입 가능. 그러나 권장사항 X
		System.out.println("f4="+f4);
		
		float f5=3.14F; //접미사 f를 통해 float임을 표현한다. 권장사항 O
