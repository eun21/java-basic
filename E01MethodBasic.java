...
/*
메소드의 규칙
-java에서는 main 메소드는 무조건 public static void로 선언하기로 약속됨.
...
public class E01MethodBasic {
	...
	/*
	메소드 정의2 : 반환형 X, 매개변수 X 형태로 정의
		-> 전달되는 값없이 이름을 입력한 후 namePrint()메소드를 호출한다.
