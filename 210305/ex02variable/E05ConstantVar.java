...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		...
		상수 : 저장된 값이 변하지 않는 메모리의 한 종류
			선언 방법 : final 자료형 상수명 = 초기값;
			-상수는 딱 '한번'만 초기화 되고, 중간에 값을 변경하면 에러 발생.
			-선언 시 전체를 대문자로 선언하고 연결되는 단어가 있는 경우
				_(언더바)를 사용한다.
			-주로 프로그램에서 코드의 '가독성'을 높여주기 위해 활용된다.
		 */
		final double PI = 3.14;
		System.out.println("PI(원주율)="+PI);
		
		//PI = 3.141592; -> 에러 발생. 상수는 한번 초기화하면 변경 불가능.
		...
		/*
		가위 바위 보 게임을 제작하기 위해 개발자는 아래와 같이 설정했다.
		가위:1, 바위:2, 보:3 
		 */
		final int SCISSOR = 1;
		final int ROCK = 2;
