...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		자동형 변환 : 작은 상자의 데이터를 큰 상자에 대입할 때 자동으로 형변환이 일어난다.
		 */
		byte b1=65;
		short s1;
		...
		/*
		아래코드는 자동형 변환이 아님. CPU는 int보다 작은 자료형을 int로 간주하고
		연산을 진행한 후 결과도 int로 반환한다.
		CPU의 특성이라 생각.
		 */
		int num1 = b1 + s1;
		...
		/*
		소숫점 아래부분이 버려짐으로 데이터 손실이 있는 경우임.
		...
		/*
		서식문자 사용 시 %.2f => 정수부는 모두 표현하고 소수이하 2자리까지만
		표현하겠다는 의미
		 */
